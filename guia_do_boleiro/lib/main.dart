...
import 'package:guia_do_boleiro/core/di/league_page_bindings.dart';
...
import 'package:guia_do_boleiro/features/league/presentation/pages/league_page.dart';
...
void main() {
  runApp(GetMaterialApp(
    ...
    getPages: [
      ...
      GetPage(
          name: leaguePageRoute,
          page: () => LeaguePage(),
          binding: LeaguePageBindings())
    ],
  ));
}
